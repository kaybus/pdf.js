...
/*
  BUILD_TARGET = BUILD_DIR + 'pdf.js';
  BUILD_WORKER_TARGET = BUILD_DIR + 'pdf.worker-'+ EXTENSION_VERSION +'.js';
  BUILD_TARGETS = [BUILD_TARGET, BUILD_WORKER_TARGET];
*/
...
BUILD_TARGET = BUILD_DIR + 'pdf.js',
  ...
  rm('-rf', BUILD_DIR + '/pdf.worker*');

  mv(KB_DIR + '/pdf.worker.js', KB_DIR + '/pdf.worker-'+ EXTENSION_VERSION +'.js');


  //echo ("BUNDLE_BUILD: "+ EXTENSION_VERSION);
